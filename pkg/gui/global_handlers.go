...
func (gui *Gui) handleMouseDownMain() error {
	...
	case gui.State.Contexts.Files:
		...
		return gui.enterFile(types.OnFocusOpts{ClickedViewName: "main", ClickedViewLineIdx: gui.Views.Main.SelectedLineIdx()})
...
func (gui *Gui) handleMouseDownSecondary() error {
	...
	case gui.Views.Files:
		return gui.enterFile(types.OnFocusOpts{ClickedViewName: "secondary", ClickedViewLineIdx: gui.Views.Secondary.SelectedLineIdx()})
	}
...
func (gui *Gui) handleCopySelectedSideContextItemToClipboard() error {
	...
	gui.PopupHandler.Toast(fmt.Sprintf("'%s' %s", truncatedItemId, gui.Tr.LcCopiedToClipboard))
